...
std::string ac::Melfa::receive(long unsigned int min_num_bytes)
{
    if (!connected_)
    ...
    do
    {
        ...
        ROS_INFO_STREAM("Melfa::receive(): received: " << buffer_string);
